...
const result = ref<Service | null>(null);
...
const services: Service[] = [
  {
    ...
    documents: ["الهوية الشخصية", "رخصة المركبة", "وثائق المركبة المطلوبة"],
